...
var facebook = {
  'sharer': `https://www.facebook.com/sharer/sharer.php?u=${window.location.origin}/special/share?image%3D@image%26title%3D@title%26description%3D@description%26quote%3D@quote%26hashtag%3D@hashtags%26redirect=@url%26utm_source%3Dfacebook%26utm_medium%3Dsocial%26utm_campaign%3Dsharing`,
  'type': 'popup'
};
var googleplus = {
...
var pinterest = {
  'sharer': 'https://pinterest.com/pin/create/button/?url=@url&image=@image&description=@title',
  'type': 'popup'
};
var reddit = {
...
var twitter = {
  'sharer': 'https://twitter.com/intent/tweet?text=@title&url=@url%3Fsharetwitter=true%26utm_source=twitter&utm_medium=social&utm_campaign=sharing',
  'type': 'popup'
};
var viber = {
...
var vk = {
  'sharer': 'https://vk.com/share.php?url=@url&title=@title&description=@description&image=@image&noparse=true&utm_source=vk.com&utm_medium=social&utm_campaign=sharing',
  'type': 'popup'
};
var weibo = {
...
var SocialSharing = {
  props: {
    ...
    /**
     * Pinterest Media URL.
     * Specifies the image/image to be used.
     */
    image: {
      type: String,
      default: ''
